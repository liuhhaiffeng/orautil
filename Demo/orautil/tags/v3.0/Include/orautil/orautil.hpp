...
// ****************************************************************************** 
// 智能ocilib::Connection, 自动关闭打开的连接
// ******************************************************************************
void ConnectionDeleter(ocilib::Connection* pCon);
//typedef void (* ConnectionDeleterType) (ocilib::Connection*);
typedef std::unique_ptr<ocilib::Connection, decltype(ConnectionDeleter)*>  AutoConnection;

// ****************************************************************************** 
// 智能ocilib::Pool, 自动关闭打开的连接池
// ******************************************************************************
void PoolDeleter(ocilib::Pool* pPool);
//typedef void (* PoolDeleterType) (ocilib::Pool*);
typedef std::unique_ptr<ocilib::Pool, decltype(PoolDeleter)*> AutoPool;

// ****************************************************************************** 
// 查询数据库是否处于连接状态
// ****************************************************************************** 
bool IsConnected(const ocilib::Connection& con);
bool IsConnected(const AutoConnection& con);
...
template<typename TDataType>
TDataType SelectOne(const AutoConnection& con, const ocilib::ostring& sql);
