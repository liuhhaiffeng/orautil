...
static void PrintRowDataFromDataset(unsigned int printrowcout = 10);
...
int main()
{
	...
	con.ExecuteTransaction("update b_kkqp_jgcl set jlbh = '000'");
	con.ExecuteTransaction("update b_kkqp_jgcl set hphm = '测试'");
	con.ExecuteTransaction("update b_kkqp_jgcl set jgsj = sysdate");
	cout << endl;
